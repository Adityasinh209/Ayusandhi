    ...
    <Layout>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container grid lg:grid-cols-2 gap-10 py-16 md:py-24 items-center">
          <div className="space-y-6">
            <Badge variant="secondary" className="rounded-full px-3 py-1 text-primary bg-primary/5">
            ...
            <p className="text-muted-foreground text-base md:text-lg max-w-prose">
              Dual‑coding integration for Ayush & ICD‑11 TM2. Search NAMASTE terms, review details in elegant dialogs, and integrate with confidence.
            </p>
      ...
      <section className="container py-12 md:py-16">
        <div className="max-w-2xl">
          ...
          <p className="mt-2 text-muted-foreground">Everything you need to search, review, and integrate terminology.</p>
        </div>
      ...
      <section className="container py-12 md:py-16">
        <div className="max-w-2xl">
          ...
          <p className="mt-2 text-muted-foreground">Simple steps to find the right terminology.</p>
        </div>
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          <Card className="transition hover:shadow-md">
            <CardHeader>
              <Badge className="w-8 h-8 rounded-full p-0 flex items-center justify-center">1</Badge>
              <CardTitle className="text-base">Search</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">Enter a term or NAMASTE code to query the service.</CardContent>
          </Card>
          <Card className="transition hover:shadow-md">
            <CardHeader>
              <Badge className="w-8 h-8 rounded-full p-0 flex items-center justify-center">2</Badge>
              <CardTitle className="text-base">Review</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">Open the dialog to view English/Hindi names, synonyms, and codes.</CardContent>
          </Card>
          <Card className="transition hover:shadow-md">
            <CardHeader>
              <Badge className="w-8 h-8 rounded-full p-0 flex items-center justify-center">3</Badge>
              <CardTitle className="text-base">Integrate</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">Use the data in your clinical apps and workflows.</CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="container py-12 md:py-16">
        <div className="rounded-2xl border p-6 md:p-8 bg-gradient-to-br from-primary/5 via-emerald-500/5 to-transparent">
          <div className="grid md:grid-cols-3 gap-6 items-center">
            ...
            <div>
              <div className="text-3xl font-bold"><span className="text-primary">FHIR</span> R4</div>
              <div className="text-muted-foreground">Terminology‑ready</div>
            </div>
            <div>
              <div className="text-3xl font-bold flex items-center gap-2"><ServerCog className="h-6 w-6 text-primary" /> CDN</div>
              <div className="text-muted-foreground">Fast global delivery</div>
            </div>
          </div>
          <Separator className="my-6" />
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <p className="text-muted-foreground">Designed for doctors and developers building modern healthcare apps.</p>
            <Button asChild>
